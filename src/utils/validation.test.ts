...
describe('validation utilities', () => {
  ...
  describe('validateAlertTitle', () => {
    ...
    it('sanitizes dangerous content in titles', () => {
      const result = validateAlertTitle('<script>alert(1)</script>Accidente grave');
  ...
  describe('validateAlertDescription', () => {
    it('accepts valid descriptions', () => {
      const result = validateAlertDescription('Hay un accidente grave en la ruta');
      expect(result.valid).toBe(true);
    });
    ...
    it('sanitizes dangerous content', () => {
      const result = validateAlertDescription('<script>alert(1)</script>Descripción válida aquí');
      expect(result.sanitized).not.toContain('<script>');
    });
  ...
  describe('validateCoordinates', () => {
    it('accepts valid coordinates', () => {
      expect(validateCoordinates(40.7128, -74.0060).valid).toBe(true);

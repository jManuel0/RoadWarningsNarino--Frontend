...
export function useRealtimeComments(alertId: number, onNewComment?: (comment: any) => void) {
...
export function useRealtimeVotes(alertId: number, onVoteChange?: (votes: { upvotes: number; downvotes: number }) => void) {
